...
{{ Form::button('<em class="fa fa-download" aria-hidden="true"></em> <span class="hidden-xs">Exportar</span>',[
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-body">
				<h4>
					<em class="fa fa-cog fa-spin fa-3x fa-fw" style="vertical-align: middle;"></em> Descargando <span class="formato"></span>...
				</h4>
			</div>
		</div>
