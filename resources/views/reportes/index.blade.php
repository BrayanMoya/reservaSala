                        ...
                        <table id="tb-info-{% $index %}" class="table table-bordered table-striped tb-info">
                            ...
                            <tbody>
                                <tr ng-repeat="fila in arrChart.datosTabla">
                                    <td>
                                        <img ng-src="../../assets/img/colors/{%getColor(fila.color)%}.jpeg" alt="Sin imagen disponible">
                                    </td>
...
<img id="logo" src="{{ asset('assets/img/logo.png') }}" class="hide" alt="Sin imagen disponible">
@parent
@endsection