	...
	<div class="modal-content">
	  ...
	  <div class="modal-body" id="divmodal" style="padding:40px 50px;">
		<div class="form-group">                
            <p>
                <strong>Descripción: </strong> <span class='AUTO_DESCRIPCION'></span><br>
                <strong>Sede: </strong> <span class='SEDE_DESCRIPCION'></span><br>
                <strong>Espacio/Sala: </strong> <span class='SALA_DESCRIPCION'></span><br>
                <strong>Fecha de Inicio: </strong> <span class='RESE_FECHAINI'></span><br>
                <strong>Fecha Fin: </strong> <span class='RESE_FECHAFIN'></span><br>
                <strong>Estado:</strong> <span class='ESTA_DESCRIPCION'></span><br>
                <strong>Total reservas:</strong> <span class='total_reservas'></span><br>
                <strong>Creado por:</strong> <span class='RESE_CREADOPOR'></span><br>
                <strong>Autorización:</strong> <span class='AUTO_ID'></span>
            </p>
        </div>
	  </div>
