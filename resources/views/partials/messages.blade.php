...
<div class="alertas">
	@if (Session::has('alert-info'))
		<div class="alert alert-info alert-flash">
			...
			<strong><em class="fa fa-info-circle fa-2x fa-pull-left" aria-hidden="true"></em></strong>
	...
	@if (Session::has('alert-success'))
		...
		<div class="alert alert-success alert-flash">
			<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			<strong><em class="fa fa-exclamation-triangle fa-2x fa-pull-left" aria-hidden="true"></em></strong>
			{{ $msg }}
		</div>
		@endforeach
	@endif
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-xs btn-success" data-dismiss="modal">
						<em class="fa fa-times" aria-hidden="true"></em> OK
					</button>
