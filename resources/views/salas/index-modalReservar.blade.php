	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					<em class="fa fa-exclamation-triangle"></em> ¿Desea Reservar esta sala <span class="SALA_ID"></span>?
				</p>
			</div>
...
<div class="modal fade" id="msgModalreserved" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-body">
				<h4>
					<em class="fa fa-cog fa-spin fa-3x fa-fw" style="vertical-align: middle;"></em> Reservado ...
				</h4>
			</div>
		</div>
