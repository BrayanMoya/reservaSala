	...
	<div class="modal-dialog">
		<div class="modal-content panel-danger">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-2">
						<em class="fas fa-exclamation-triangle fa-3x fa-fw"></em>
					</div>
					<div class="col-xs-10">
			...
			<div class="modal-footer">
				<form id="frmDelete" method="POST" action="" accept-charset="UTF-8" class="frmModal pull-right">
					<button type="button" class="btn btn-xs btn-default" data-dismiss="modal">
						<em class="fas fa-times" aria-hidden="true"></em> NO
					</button>

					{{ Form::token() }}
					{{ Form::hidden('_method', 'DELETE') }}
					{{ Form::button('<em class="fas fa-trash" aria-hidden="true"></em> SI ',[
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-body text-center">
				<h4>
					<em class="fas fa-cog fa-spin fa-2x fa-fw" style="vertical-align: middle;"></em> Borrando registro...
				</h4>
			</div>
		</div>
