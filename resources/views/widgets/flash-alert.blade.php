...
<div class="alerts">
	...
	@if (Session::has('alert-info'))
		...
		<div class="alert alert-info alert-flash">
			...
			<strong><em class="fas fa-info-circle fa-2x fa-pull-left" aria-hidden="true"></em></strong>
			{{ $msg }}
		</div>
		@endforeach
	@endif
	...
	@if (Session::has('alert-success'))
		...
		<div class="alert alert-success alert-flash">
			<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			<strong><em class="fas fa-check fa-2x fa-pull-left" aria-hidden="true"></em></strong>
			{{ $msg }}
		</div>
		@endforeach
	@endif
	...
	@if (Session::has('alert-warning'))
		...
		<div class="alert alert-warning alert-flash">
			<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			<strong>
				<em class="fas fa-exclamation-triangle fa-2x fa-pull-left" aria-hidden="true"></em>
				{{ $msg }}
			</strong>
		</div>
		@endforeach
	...
	@if (Session::has('alert-danger'))
		...
		<div class="alert alert-danger alert-flash">
			<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			<strong>
				<em class="fas fa-exclamation-circle fa-2x fa-pull-left" aria-hidden="true"></em>
				{{ $msg }}
			</strong>
		</div>
		@endforeach
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-xs btn-success" data-dismiss="modal">
					<em class="fas fa-times" aria-hidden="true"></em> OK
				</button>
			</div>
		</div>
	</div>
