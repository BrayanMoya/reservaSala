          ...
          <td valign="top" style="width:300px">
             <table width="299" border="0">
                <tbody>
                   ...
                   <tr>
                      <td style="padding-bottom:10px;padding-left:28px;padding-right:5px;padding-top:5px;font-size:14px;background-color:#ff5b5b">{{ $autorizacion->reservas->first()->autorizaciones-> first()->estado->ESTA_DESCRIPCION }}</td>
                   </tr>
                </tbody>
             </table>
          </td>
