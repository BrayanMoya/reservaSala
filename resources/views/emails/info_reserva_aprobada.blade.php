      ...
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
       ...
       <tr>
          <td colspan="2" style="padding-left:25px;padding-right:25px;height:40px"><b>Estimado usuario</b>,
             gracias por usar el servicio de Reserva Salas de Uniajc®. Los datos de su reservación realizada están indicados a continuación. Que disfrute su clase.
          </td>
       </tr>
       <tr>
          <td valign="top" style="width:300px">
             <table width="299" border="0">
                <tbody>
                   ...
                   <tr>
                      <td style="padding-bottom:10px;padding-left:28px;padding-right:5px;padding-top:5px;font-size:14px;background-color:#34e51f">{{ $autorizacion->reservas->first()->autorizaciones-> first()->estado->ESTA_DESCRIPCION }}</td>
                   </tr>
                </tbody>
             </table>
          </td>
