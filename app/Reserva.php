...
class Reserva extends ModelWithSoftDeletes
{
    ...
    protected $fillable = [
        ...
        'RESE_CODMATERIA',
        'RESE_NOMMATERIA',
        'RESE_CREADAPORUNIAJC',
        'RESE_USUARIOUNIAJC',
        'RESE_EMAILUSERUNIAJC',
        'RESE_IDENTIFICACIONUNIAJC',
        'RESE_NOMBREUSERUNIAJC',
        'RESE_APELLIDOUSERNUNIAJC'

    ];


    //Constantes para colores asignados al estado de la reserva
    const COLOR_PENDIENTE  = 'rgb(153, 153, 102)'; //Yellow
    ...
    {
        return $query->join('RESERVAS_AUTORIZADAS',
