...
WebUI.setText(findTestObject('Object Repository/verRE/Page_Reservas/input_Usuario_username'), 'cabolaños')

WebUI.setEncryptedText(findTestObject('Object Repository/verRE/Page_Reservas/input_Contrasea_password'), 'iGDxf8hSRT4=')

WebUI.click(findTestObject('Object Repository/verRE/Page_Reservas/button_Iniciar sesin'))
